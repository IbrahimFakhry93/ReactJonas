...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  const [payer, setpayer] = useState("user"); //* put the default value, the defaut value of options (user === you), look down the option tag
    ...
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input
        ...
        onChange={(e) =>
          ...
          //* if not the state value will equil the Number(e.target.value)
          //? in another words
