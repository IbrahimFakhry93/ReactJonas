...
//* to function as a table, even we use div not table htmlelement
{
  /* <Table role="table">
...
//* and the state associated with it (like cabin data) becomes inactive in React Query devtools
...
//* The mutation is successful at this point.
