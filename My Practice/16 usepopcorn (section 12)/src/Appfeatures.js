...
//! this function recieves the id of the movie as an argument to fetch an other api to get the selected move to display its details
...
//~ Solution:
//* We can clean up, basically our fetch requests,
//* so that, as soon as a new request is fired off, the previous one will stop. So it will get canceled.
