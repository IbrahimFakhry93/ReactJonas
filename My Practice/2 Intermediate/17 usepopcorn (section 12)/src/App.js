...
export default function App() {
  ...
  //* this also will cause infinite fetch request, you can check that in network tab in the browser inspector
  ...
  useEffect(function () {
    console.log("run with any prop or state update"); //* third one: (will always triggered after any render)
  ...
  */
  ...
  useEffect(
    function () {
      //*  use a native browser API to solve race condition issue (look up App features.js file, video 156)
